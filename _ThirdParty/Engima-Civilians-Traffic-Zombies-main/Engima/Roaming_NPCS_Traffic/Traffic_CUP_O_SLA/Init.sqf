...
if (isServer) then {
	...
	call compile preprocessFileLineNumbers "globalScripts\_ThirdParty\Engima-Civilians-Traffic-Zombies-main\Engima\Roaming_NPCS_Traffic\Traffic_CUP_O_SLA\ConfigAndStart.sqf";
};
