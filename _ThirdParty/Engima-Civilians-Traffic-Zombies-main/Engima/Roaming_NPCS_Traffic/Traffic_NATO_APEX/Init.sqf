...
if (isServer) then {
	...
	call compile preprocessFileLineNumbers "globalScripts\_ThirdParty\Engima-Civilians-Traffic-Zombies-main\Engima\Roaming_NPCS_Traffic\Traffic_NATO_APEX\ConfigAndStart.sqf";
};
